...
**Table of Contents**
- [Podcast API Go Library](#podcast-api-go-library)
...
Then, reference podcast-api-go in a Go program with `import`:
...
```
go get -u github.com/ListenNotes/podcast-api-go
```
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.Typeahead(map[string]string{
        "q":                "startup",
        "show_podcasts":    "1", 
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchPodcastByID("4d3fe717742d4963a85562e9f84d8c79", map[string]string{
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchEpisodeByID("6b6d65930c5a4f71b254465871fed370", map[string]string{
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchRecommendationsForPodcast("25212ac3c53240a880dd5032e547047b", map[string]string{
        "safe_mode":    "1",
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchRecommendationsForEpisode("914a9deafa5340eeaa2859c77f275799", map[string]string{
        "safe_mode":    "1",
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.JustListen(nil)
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchCuratedPodcastsListByID("SDFKduyJ47r", map[string]string{
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.DeletePodcast("4d3fe717742d4963a85562e9f84d8c79", map[string]string{
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchPlaylistByID("m1pe7z60bsw", map[string]string{
        "type": "podcast_list",
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchTrendingSearches(map[string]string{
})
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchRelatedSearches(map[string]string{
    "q":    "evergrande",
})
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.SpellCheck(map[string]string{
    "q":    "evergrand stok",
})
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchAudienceForPodcast("25212ac3c53240a880dd5032e547047b", map[string]string{
    })
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.FetchPodcastsByDomain("nytimes.com", map[string]string{
    "page": "1",
})
...
func main() {
    apiKey := os.Getenv("LISTEN_API_KEY")
    client := listennotes.NewClient(apiKey)
    resp, err := client.SearchEpisodeTitles(map[string]string{
